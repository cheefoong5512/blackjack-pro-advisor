  ...
  return (
    <div className="min-h-screen bg-slate-800 text-slate-100 font-sans pb-24 selection:bg-emerald-500/30 relative">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Main Layout Grid: Content on Left, Ads on Right */}
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-3/4 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 items-start">
              ...
              {/* Inner Left Column: Tracking & Education */}
              <div className="space-y-6">
                ...
                <section className="bg-slate-700 border border-slate-600 rounded-2xl p-6 shadow-lg space-y-4">
                  <div>
                    <h3 className="text-sm font-bold text-slate-200 uppercase tracking-wider mb-2">Estimating Decks</h3>
                    <p className="text-sm text-slate-300 mb-2">
                      Divide your Running Count by the unplayed decks to get the True Count. Look at the discard tray to the dealer's right, estimate the decks inside, and subtract that from the starting total.
                    </p>
                    <p className="italic text-xs text-slate-400">
                      <strong>Pro Tip:</strong> One physical deck is roughly 0.6 inches (1.5 cm) thick.
                    </p>
                  </div>
              ...
              {/* Inner Right Column: The Hand Inputs */}
              <div className="space-y-6">
                <section className="bg-slate-700 border border-slate-600 rounded-2xl p-6 shadow-lg">
          ...
          <aside className="w-full lg:w-1/4 flex flex-col gap-6">
            ...
            {/* Ad Placeholder 1 */}
            <div className="bg-slate-700 border border-slate-600 rounded-2xl h-[250px] flex flex-col items-center justify-center text-slate-400 shadow-lg">
              <span className="text-xs uppercase tracking-widest font-bold mb-2 opacity-50">Advertisement</span>
              <p className="text-sm text-center px-4">AdSense 300x250<br/>Square Ad Goes Here</p>
            </div>

            {/* Ad Placeholder 2 (Vertical) */}
            <div className="bg-slate-700 border border-slate-600 rounded-2xl h-[600px] hidden md:flex flex-col items-center justify-center text-slate-400 shadow-lg sticky top-8">
              <span className="text-xs uppercase tracking-widest font-bold mb-2 opacity-50">Advertisement</span>
              <p className="text-sm text-center px-4">AdSense 300x600<br/>Vertical Skyscraper<br/>(Sticky on Scroll)</p>
            </div>
